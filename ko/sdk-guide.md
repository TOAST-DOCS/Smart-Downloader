...
유니티 'Project Settings > Android > Publish Settings > Split Application Binary' 설정이 활성화하고 Android 빌드를 하면 APK 파일과 확장 파일인 OBB 파일로 나누어집니다. ([Unity Manual - APK 확장 파일 지원](https://docs.unity3d.com/kr/current/Manual/android-OBBsupport.html))
