...
## Game > Smart Downloader > 개요 { #game-smart-downloader-overview }
...
### 간편한 업로드 및 업로드/배포 파일 생성 자동화 { #allow-simple-uploads-and-automate-uploadingcreating-deployment-files }
