...
유니티 'Project Settings > Android > Publish Settings > Split Application Binary' 설정이 활성화하고 Android 빌드를 하면 APK 파일과 확장 파일인 OBB 파일로 나누어집니다. ([Unity Manual - Support for APK expansion files (OBB)](https://docs.unity3d.com/Manual/android-OBBsupport.html))
