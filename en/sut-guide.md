...
* Most Recent Uploads 
    ...
    * Deployment Status: Check status of deployment. See [Console User Guide](http://docs.toast.com/en/Game/Smart%20Downloader/en/console-guide/#4-list-of-services) for deployment status. 
